...
function getSameSitePolicy() {
  ...
  // Capacitor apps can run your hosted site inside WKWebView where cookie handling
  // may be treated as cross-site. In those cases, SameSite=None + Secure is required.
