// No daily quota on the human act of vouching — a wingman's generosity should
// never hit a meter. `null` means unlimited for every tier. (Kept as a table so a
// future cap could be reintroduced per-tier without touching the enforcement code.)
