...
// Hot path: the feed ranker's desirability stats aggregate by target_user_id alone.
// Without target_user_id leading, the queries above can't serve it (compound-prefix rule)
// and Mongo collection-scans on every feed request.
SwipeSchema.index({ target_user_id: 1, direction: 1 });
