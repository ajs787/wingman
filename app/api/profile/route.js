...
export async function GET(request) {
  ...
  const profile = {
    ...
    hidden_prompt: user.hidden_prompt,
    hidden_prompt_answer: user.hidden_prompt_answer,
...
const profileSchema = z.object({
  ...
  hidden_prompt:      z.string().max(200).nullable().optional(),
  hidden_prompt_answer: z.string().max(500).nullable().optional(),
